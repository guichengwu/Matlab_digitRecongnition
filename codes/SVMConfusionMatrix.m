function confusionMatrix = SVMConfusionMatrix(trainX, trainY, labelIndex, testX, testY)
class0 = 0;
class1 = 1;
class2 = 2;
class3 = 3;
...
[trainX, trainY0, alpha0, beta00] = SVMDigitClassifier_1(trainX, trainY(1:labelIndex(1)), class0, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY1, alpha1, beta01] = SVMDigitClassifier_1(trainX, trainY((labelIndex(1)+1):labelIndex(2)), class1, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY2, alpha2, beta02] = SVMDigitClassifier_1(trainX, trainY((labelIndex(2)+1):labelIndex(3)), class2, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY3, alpha3, beta03] = SVMDigitClassifier_1(trainX, trainY((labelIndex(3)+1):labelIndex(4)), class3, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY4, alpha4, beta04] = SVMDigitClassifier_1(trainX, trainY((labelIndex(4)+1):labelIndex(5)), class4, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY5, alpha5, beta05] = SVMDigitClassifier_1(trainX, trainY((labelIndex(5)+1):labelIndex(6)), class5, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY6, alpha6, beta06] = SVMDigitClassifier_1(trainX, trainY((labelIndex(6)+1):labelIndex(7)), class6, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY7, alpha7, beta07] = SVMDigitClassifier_1(trainX, trainY((labelIndex(7)+1):labelIndex(8)), class7, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY8, alpha8, beta08] = SVMDigitClassifier_1(trainX, trainY((labelIndex(8)+1):labelIndex(9)), class8, C, epsion, sigma, d, k1, k2, kernelType);
[trainX, trainY9, alpha9, beta09] = SVMDigitClassifier_1(trainX, trainY((labelIndex(9)+1):labelIndex(10)), class9, C, epsion, sigma, d, k1, k2, kernelType);
